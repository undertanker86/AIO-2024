...
def regression_loss_functions(num_samples, loss_name):
    ...
    if loss_name == "MAE":
        ...
        for i in range(int(num_samples)):
            ...
            print("loss name : {0} , sample : {1} , pred : {2} , target : {3} , loss : {4}".format(loss_name, i, predict, target, loss_sample))
    ...
    if loss_name == "RMSE":
        ...
        for i in range(int(num_samples)):
            ...
            sum_loss += loss_sample
            print("loss name : {0} , sample : {1} , pred : {2} , target : {3} , loss : {4}".format(loss_name, i, predict, target, loss_sample))
        print("final {0}: {1}".format(loss_name, math.sqrt(sum_loss / int(num_samples))))
